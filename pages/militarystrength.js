 function calculateMilitaryStrength(countryData) {
    ...
    // Apply resonance effect if present
    let resonanceMultiplier = 1;
    if (countryData.resonance) {
        resonanceMultiplier = countryData.resonance[1];
    }

    const motorStrength = (countryData.motor * resonanceMultiplier) / 700;
    const navyStrength = (countryData.navy * resonanceMultiplier) / 300;
    const airforceStrength = (countryData.airforce * resonanceMultiplier) / 200;
